...
def get_offerer_cultural_activity_dataframe(
    siren_dataframe: pandas.DataFrame,
) -> pandas.DataFrame:
    offerer_cultural_activity_dataframe = siren_dataframe.copy()
    offerer_cultural_activity_dataframe[
        "APE_code"
    ] = offerer_cultural_activity_dataframe["siren"].apply(get_ape_code_by_siren)
    offerer_cultural_activity_dataframe[
        "APE_label"
    ] = offerer_cultural_activity_dataframe["APE_code"].apply(
