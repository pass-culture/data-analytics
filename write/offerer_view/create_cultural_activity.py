...
from transform.compute_offerer_cultural_activity import (
    get_offerer_cultural_activity_dataframe,
)


def create_offerer_cultural_activity_data(ENGINE) -> None:
    siren_dataframe = get_siren_dataframe(ENGINE)
    offerer_cultural_activity_dataframe = get_offerer_cultural_activity_dataframe(
        siren_dataframe
    )
    _create_table_offerer_cultural_activity(offerer_cultural_activity_dataframe, ENGINE)


def _create_table_offerer_cultural_activity(
    offerer_cultural_activity_dataframe: pandas.DataFrame, ENGINE
) -> None:
