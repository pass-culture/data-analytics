...
from read.postgresql_database.offerer_queries import (
    get_siren_dataframe,
    get_postal_code_dataframe,
)
...
class OffererQueriesTest:
    ...
    class GetSirenDataFrameTest:
        ...
        def test_should_return_siren_related_to_existing_offerers(self, app):
            ...
            expected_siren_dataframe = pandas.DataFrame(
                data={"id": [1, 3], "siren": ["345678123", "123456789"]}
            )
    ...
    class GetPostalCodeDataFrameTest:
        ...
        def test_should_return_postal_code_related_to_existing_offerers(self, app):
            ...
            expected_postal_code_dataframe = pandas.DataFrame(
                data={"id": [1, 2], "postalCode": ["75003", "97459"]}
            )
            ...
            pandas.testing.assert_frame_equal(
                postal_code_dataframe, expected_postal_code_dataframe
            )
