...
class VenueQueriesTest:
    ...
    class GetNumberOfBookingsTest:
        def test_should_return_exact_number_of_bookings(self, app):
            ...
            create_offer(venue_id=1, product_id=2, id=2, product_type='ThingType.MUSIQUE')
            create_stock(offer_id=2, id=2)
            create_booking(id=1, user_id=1, quantity=1, stock_id=2, is_used=True)
            create_booking(id=2, user_id=1, quantity=1, stock_id=2, token='ABC321', is_used=True)
            create_booking(id=3, user_id=1, quantity=3, stock_id=2, token='FAM321', is_cancelled=True)
    ...
    class GetNumberOfNonCancelledBookingsTest:
        def test_should_return_exact_number_of_non_cancelled_bookings(self, app):
            ...
            expected_number_of_non_cancelled_bookings_per_venue = pandas.Series(data=[2], name="non_cancelled_bookings", index=Int64Index([1],name='venue_id'))
            ...
            # Then
            with ENGINE.connect() as connection:
                total_non_cancelled_bookings_per_venue = pandas.read_sql(query, connection, index_col='venue_id')
            pandas.testing.assert_series_equal(total_non_cancelled_bookings_per_venue['non_cancelled_bookings'],expected_number_of_non_cancelled_bookings_per_venue)
    ...
    class GetNumberOfUsedBookingsTest:
        def test_should_return_exact_number_of_used_bookings(self, app):
            ...
            create_booking(id=3, user_id=1, quantity=3, stock_id=2, token='FAM321', is_cancelled=True)
            create_booking(id=4, user_id=1, quantity=3, stock_id=1, token='CON321')
            expected_number_of_used_bookings_per_venue = pandas.Series(data=[2],
                                                                                name="used_bookings",
                                                                                index=Int64Index([1],
                                                                                                 name='venue_id'))
            ...
            # Then
            with ENGINE.connect() as connection:
                total_used_bookings_per_venue = pandas.read_sql(query, connection, index_col='venue_id')
            pandas.testing.assert_series_equal(total_used_bookings_per_venue['used_bookings'],
    ...
    class GetFirstOfferCreationDateTest:
        def test_should_return_first_offer_creation_date(self, app):
            ...
            create_stock(offer_id=1, id=1)
            create_product(id=2, product_type='ThingType.MUSIQUE')
            create_offer(venue_id=1, product_id=2, id=2, product_type='ThingType.MUSIQUE',date_created='2020-05-10')
            create_offer(venue_id=1, product_id=2, id=3, product_type='ThingType.MUSIQUE',
            ...
            create_booking(id=3, user_id=1, quantity=3, stock_id=2, token='FAM321', is_cancelled=True)
            create_booking(id=4, user_id=1, quantity=3, stock_id=1, token='CON321')
            expected_first_offer_creation_date = pandas.Series(data=['2020-05-10'],
                                                                       name="first_offer_creation_date",
                                                                       index=Int64Index([1],
                                                                                        name='venue_id'))
            expected_first_offer_creation_date = pandas.to_datetime(expected_first_offer_creation_date,
                                                                    format='%Y-%m-%d')
            # When
            ...
            # Then
            with ENGINE.connect() as connection:
                first_offer_creation_date = pandas.read_sql(query, connection, index_col='venue_id')
            pandas.testing.assert_series_equal(expected_first_offer_creation_date,
    ...
    class GetLastOfferCreationDateTest:
        def test_should_return_last_offer_creation_date(self, app):
            ...
            create_venue(offerer_id=1, id=1)
            create_product(id=1, product_type='ThingType.ACTIVATION')
            create_offer(venue_id=1, product_id=1, id=1, product_type='ThingType.ACTIVATION',date_created='2020-05-13')
            create_stock(offer_id=1, id=1)
            create_product(id=2, product_type='ThingType.MUSIQUE')
            create_offer(venue_id=1, product_id=2, id=2, product_type='ThingType.MUSIQUE',date_created='2020-05-10')
            create_offer(venue_id=1, product_id=2, id=3, product_type='ThingType.MUSIQUE',
            ...
            create_booking(id=3, user_id=1, quantity=3, stock_id=2, token='FAM321', is_cancelled=True)
            create_booking(id=4, user_id=1, quantity=3, stock_id=1, token='CON321')
            expected_last_offer_creation_date = pandas.Series(data=['2020-05-11'],
                                                                       name="last_offer_creation_date",
                                                                       index=Int64Index([1],
                                                                                        name='venue_id'))
            expected_last_offer_creation_date = pandas.to_datetime(expected_last_offer_creation_date,
                                                                    format='%Y-%m-%d')
            # When
    ...
    class TheoreticalRevenuePerVenueTest:
        def test_should_return_theoretic_revenue_per_venue(self, app):
            ...
            create_booking(id=1, user_id=1, quantity=1, stock_id=2, amount=10, is_used=True)
            create_booking(id=2, user_id=1, quantity=1, stock_id=2, amount=10, token='ABC321', is_used=True)
            create_booking(id=3, user_id=1, quantity=1, stock_id=2, amount=10, token='FAM321', is_cancelled=True)
            create_booking(id=4, user_id=1, quantity=1, stock_id=1, token='CON321',is_cancelled=False)
            create_booking(id=5, user_id=1, quantity=2, stock_id=3, amount=20, token='LAB123', is_cancelled=False)
            expected_theoretic_revenue_per_venue = pandas.Series(data=[60.0],
            ...
            # Then
            with ENGINE.connect() as connection:
                theoretic_revenue_per_venue = pandas.read_sql(query, connection, index_col='venue_id')
            pandas.testing.assert_series_equal(expected_theoretic_revenue_per_venue,
    ...
    class RealRevenuePerVenueTest:
        def test_should_return_real_revenue_per_venue(self, app):
            ...
            create_booking(id=4, user_id=1, quantity=1, stock_id=1, token='CON321',is_cancelled=False)
            create_booking(id=5, user_id=1, quantity=2, stock_id=3, amount=20, token='LAB123', is_cancelled=False)
            expected_real_revenue_per_venue = pandas.Series(data=[20.0],
                                                                       name="real_revenue",
                                                                       index=Int64Index([1],
                                                                                        name='venue_id'))
            # When
            ...
            # Then
            with ENGINE.connect() as connection:
                real_revenue_per_venue = pandas.read_sql(query, connection, index_col='venue_id')
            pandas.testing.assert_series_equal(expected_real_revenue_per_venue,
