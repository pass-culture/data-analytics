...
class VenueQueriesTest:
    ...
    class GetNumberOfBookingsTest:
        def test_should_return_exact_number_of_bookings(self, app):
            ...
            create_offer(app, venue_id=1, product_id=2, id=2, product_type='ThingType.MUSIQUE')
    ...
    class TheoreticalRevenuePerVenueTest:
        def test_should_return_theoretic_revenue_per_venue(self, app):
            # Given
            create_user(app, id=1)
            create_deposit(app, id=1, user_id=1)
            create_offerer(app, id=1)
            create_venue(app, offerer_id=1, id=1)
            create_product(app, id=1, product_type='ThingType.ACTIVATION')
            create_offer(app, venue_id=1, product_id=1, id=1, product_type='ThingType.ACTIVATION',date_created='2020-05-13')
            ...
            create_offer(app, venue_id=1, product_id=2, id=3, product_type='ThingType.MUSIQUE',
                         date_created='2020-05-11')
            create_stock(app, offer_id=2, id=2, price=10)
            create_stock(app, offer_id=3, id=3, price=20)
            create_booking(app, id=1, user_id=1, quantity=1, stock_id=2, amount=10, is_used=True)
            create_booking(app, id=2, user_id=1, quantity=1, stock_id=2, amount=10, token='ABC321', is_used=True)
            create_booking(app, id=3, user_id=1, quantity=1, stock_id=2, amount=10, token='FAM321', is_cancelled=True)
            create_booking(app, id=4, user_id=1, quantity=1, stock_id=1, token='CON321',is_cancelled=False)
            create_booking(app, id=5, user_id=1, quantity=2, stock_id=3, amount=20, token='LAB123', is_cancelled=False)
