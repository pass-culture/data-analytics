...
from tests.data_creators import create_user, create_product, create_offerer, create_venue, create_offer, create_deposit, \
    create_stock, create_booking, create_favorite
from utils.database_cleaners import clean_database, clean_views
from write.create_intermediate_views_for_offer import _get_is_physical_information_query, \
    _get_is_outing_information_query, _get_offer_booking_information_query, _get_count_favorites_query, \
...
class OfferQueriesTest:
    ...
    class GetIsPhysicalInformationQueryTest:
        ...
        def test_should_return_physical_product_column_with_true_if_relevant_product_type(self, offer_type):
            # Given
            create_user(id=1)
            create_product(id=1)
            create_offerer(id=1)
            create_venue(offerer_id=1, id=1, siret=None, postal_code=None, city=None, departement_code=None,
                         is_virtual=True)
        ...
        def test_should_return_physical_product_column_with_false_if_not_relevant_product_type(self):
            # Given
            create_user(id=1)
            create_product(id=1)
            create_offerer(id=1)
            create_venue(offerer_id=1, id=1, siret=None, postal_code=None, city=None, departement_code=None,
                         is_virtual=True)
            create_offer(venue_id=1, product_id=1, id=1, product_type='ThingType.CINEMA_CARD')
    ...
    class GetIsOutingInformationQueryTest:
        ...
        def test_should_return_outings_column_with_true_if_relevant_product_type(self, offer_type):
            # Given
            create_user(id=1)
            create_product(id=1)
            create_offerer(id=1)
        ...
        def test_should_return_outings_column_with_false_if_not_relevant_product_type(self):
            # Given
            create_user(id=1)
            create_product(id=1)
            create_offerer(id=1)
            create_venue(offerer_id=1, id=1, siret=None, postal_code=None, city=None, departement_code=None,
                         is_virtual=True)
            create_offer(venue_id=1, product_id=1, id=1, product_type='ThingType.LIVRE_EDITION')
    ...
    class GetOfferBookingInformationQueryTest:
        ...
        def test_should_return_booking_cancelled_booking_and_used_booking_number_columns(self):
            # Given
            create_user(id=1)
            ...
            create_booking(id=1, user_id=1, amount=10, quantity=1, stock_id=20, is_used=True)
            create_booking(id=2, user_id=1, amount=10, quantity=1, stock_id=20, token='ABC321', is_used=True)
            create_booking(id=3, user_id=1, amount=10, quantity=3, stock_id=20, token='FAM321', is_cancelled=True)
