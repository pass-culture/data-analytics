...
def create_offer(venue_id, product_id, id=1, is_active=True, product_type='ThingType.LIVRE_EDITION', name='Livre',
...
def create_stock(offer_id, id=1, is_soft_deleted=False, date_modified='2019-11-20', date_created='2019-11-20',
