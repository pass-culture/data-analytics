...
from utils.initialize_metabase import (
    get_setup_token,
    initialize_metabase_if_local,
    post_create_metabase_superuser,
)
...
class InitializeMetabaseIfLocalTest:
    ...
    def test_get_setup_token_should_return_token_setup(self, mock_request):
        ...
        calls = [
            call("metabase.example.com/setup"),
            call("metabase.example.com/api/session/properties"),
        ]
    ...
    def test_post_create_metabase_superuser_should_call_metabase_api(
        self, mock_request
    ):
        # Given / When
        ...
        mock_request.assert_called_once_with(
            "metabase.example.com/api/setup",
            json={
                "token": "setup_token",
    ...
    def test_initialize_metabase_if_local_should_call_setup_functions(
        self, mock_get_setup_token, mock_post_create_metabase_superuser
    ):
        # Given
