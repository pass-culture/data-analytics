...
def test_edit_dump_table_connection_when_url_is_remote(mock_configure_new_metabase_session, mock_get_connected_database_id, mock_get_app_name_for_restore, mock_get_db_details_by_app_name, mock_request):
    # Given
    table_name = 'table_name'
    user_name = 'user_name'
    password = 'password'
