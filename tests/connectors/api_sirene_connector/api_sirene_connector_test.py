...
from connectors.api_sirene_connector.api_sirene_connector import get_offerer_details_by_siren


class GetOffererDetailsBySirenTest:
    @patch('connectors.api_sirene_connector.api_sirene_connector.requests.get')
    def test_should_request_correct_endpoint_of_api_sirene(self, request_get):
        ...
        # Then
        request_get.assert_called_once_with(f"https://entreprise.data.gouv.fr/api/sirene/v3/unites_legales/123456789")
    ...
    @patch('connectors.api_sirene_connector.api_sirene_connector.requests.get')
    def test_should_return_return_empty_dict_when_status_code_is_not_200(self, request_get):
        # Given
        siren = '123456789'
